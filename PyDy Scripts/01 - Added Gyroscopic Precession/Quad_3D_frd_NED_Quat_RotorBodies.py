...
R3 = ReferenceFrame('R3') 
R4 = ReferenceFrame('R4') 
...
qR1, qR2, qR3, qR4 = dynamicsymbols('qR1 qR2 qR3 qR4')

# Constants
# ---------------------------
mB, g, dxm, dym, dzm, IBxx, IByy, IBzz, mR, IRzz, wM1, wM2, wM3, wM4 = symbols('mB g dxm dym dzm IBxx IByy mR IBzz IRzz wM1 wM2 wM3 wM4')
...
R1.orient(B, 'Axis', [qR1, B.z])
R2.orient(B, 'Axis', [qR2, B.z])
R3.orient(B, 'Axis', [qR3, B.z])
R4.orient(B, 'Axis', [qR4, B.z])

R1.set_ang_vel(B,  wM1*B.z)
R2.set_ang_vel(B, -wM2*B.z)
R3.set_ang_vel(B,  wM3*B.z)
R4.set_ang_vel(B, -wM4*B.z)
...
IR1 = inertia(R1, 0, 0, IRzz)
IR2 = inertia(R2, 0, 0, IRzz)
IR3 = inertia(R3, 0, 0, IRzz)
IR4 = inertia(R4, 0, 0, IRzz)

# Create Bodies
# ---------------------------
BodyB = RigidBody('BodyB', Bcm, B, mB, (IB, Bcm))
BodyR1 = RigidBody('BodyR1', M1, R1, mR, (IR1, M1))
BodyR2 = RigidBody('BodyR2', M2, R1, mR, (IR2, M2))
BodyR3 = RigidBody('BodyR3', M3, R1, mR, (IR3, M3))
BodyR4 = RigidBody('BodyR4', M4, R1, mR, (IR4, M4))
BodyList = [BodyB, BodyR1, BodyR2, BodyR3, BodyR4]
